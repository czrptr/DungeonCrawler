...
namespace DungeonCrawler.Graphix
{
    public static class GraphicsHelper
    {
        ...
        public static void FillCustomBorder(this Graphics graphics, CustomBorder customBorder, Rectangle rect)
        {
        ...
        public static void FillCustomBorder(this Graphics graphics, CustomBorder customBorder, int x, int y, int width, int height)
        {
            FillCustomBorder(graphics, customBorder, new Rectangle(x, y, width, height));
        }
    }
}
